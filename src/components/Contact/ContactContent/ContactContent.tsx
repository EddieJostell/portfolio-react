...
const ContactContent = (props: Props) => {
  return (
    <ul className="flex flex-col items-center justify-between w-full mt-12 md:flex-row md:mt-24 md:justify-around">
      <li className="flex flex-col items-center justify-center w-48 h-48 shadow-2xl">
        <div className="">
      ...
      <li className="flex flex-col items-center justify-center w-48 h-48 shadow-2xl">
        <div className="">
          <a href="mailto:eddie.jostell@gmail.com">
            <img className="w-12 h-12" src={iconMail} />
          </a>
        </div>
        <a
      ...
      <li className="flex flex-col items-center justify-center w-48 h-48 shadow-2xl">
        <div className="">
          <a
            ...
            target="_blank"
          >
            <img className="w-12 h-12" src={iconLinkedIn} />
          </a>
        </div>
        <a
          className="active:text-white hover:text-orange hover:underline"
      ...
      <li className="flex flex-col items-center justify-center w-48 h-48 shadow-2xl">
        <div className="">
          <a
            ...
            target="_blank"
          >
            <img className="w-12 h-12" src={iconGitHub} />
          </a>
        </div>
        <a
          className="active:text-white hover:text-orange hover:underline"
